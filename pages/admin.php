...
<?php if ($_GET["choix"] == "publier") {
  ...
  <input style="width:50vh;" class="form-control" type="text" name="titre" placeholder="Titre"><br>
  ...
  <input style="width:50vh" class="form-control" type="file" name="userfiles"><br>
